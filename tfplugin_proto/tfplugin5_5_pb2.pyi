...
class Diagnostic(_message.Message):
    __slots__ = ["severity", "summary", "detail", "attribute", "function_argument"]
    ...
    def __init__(self, severity: _Optional[_Union[Diagnostic.Severity, str]] = ..., summary: _Optional[str] = ..., detail: _Optional[str] = ..., attribute: _Optional[_Union[AttributePath, _Mapping[Any, Any]]] = ..., function_argument: _Optional[int] = ...) -> None: ...
...
class Schema(_message.Message):
    ...
    class Attribute(_message.Message):
        __slots__ = ["name", "type", "description", "required", "optional", "computed", "sensitive", "description_kind", "deprecated"]
        ...
        description_kind: StringKind
        deprecated: bool
        def __init__(self, name: _Optional[str] = ..., type: _Optional[bytes] = ..., description: _Optional[str] = ..., required: bool = ..., optional: bool = ..., computed: bool = ..., sensitive: bool = ..., description_kind: _Optional[_Union[StringKind, str]] = ..., deprecated: bool = ...) -> None: ...
...
class ServerCapabilities(_message.Message):
    __slots__ = ["plan_destroy", "get_provider_schema_optional"]
    ...
    def __init__(self, plan_destroy: bool = ..., get_provider_schema_optional: bool = ...) -> None: ...
...
class Function(_message.Message):
    ...
    def __init__(self, parameters: _Optional[_Iterable[_Union[Function.Parameter, _Mapping[Any, Any]]]] = ..., variadic_parameter: _Optional[_Union[Function.Parameter, _Mapping[Any, Any]]] = ..., summary: _Optional[str] = ..., description: _Optional[str] = ..., description_kind: _Optional[_Union[StringKind, str]] = ..., deprecation_message: _Optional[str] = ..., **kwargs) -> None: ...
...
class GetMetadata(_message.Message):
    ...
    class Response(_message.Message):
        ...
        def __init__(self, server_capabilities: _Optional[_Union[ServerCapabilities, _Mapping[Any, Any]]] = ..., diagnostics: _Optional[_Iterable[_Union[Diagnostic, _Mapping[Any, Any]]]] = ..., data_sources: _Optional[_Iterable[_Union[GetMetadata.DataSourceMetadata, _Mapping[Any, Any]]]] = ..., resources: _Optional[_Iterable[_Union[GetMetadata.ResourceMetadata, _Mapping[Any, Any]]]] = ..., functions: _Optional[_Iterable[_Union[GetMetadata.FunctionMetadata, _Mapping[Any, Any]]]] = ...) -> None: ...
...
class GetProviderSchema(_message.Message):
    ...
    class Request(_message.Message):
        ...
        def __init__(self) -> None: ...
    class Response(_message.Message):
        __slots__ = ["provider", "resource_schemas", "data_source_schemas", "functions", "diagnostics", "provider_meta", "server_capabilities"]
        ...
        class FunctionsEntry(_message.Message):
            ...
            key: str
            value: Function
            def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[Function, _Mapping[Any, Any]]] = ...) -> None: ...
        ...
        server_capabilities: ServerCapabilities
        def __init__(self, provider: _Optional[_Union[Schema, _Mapping[Any, Any]]] = ..., resource_schemas: _Optional[_Mapping[str, Schema]] = ..., data_source_schemas: _Optional[_Mapping[str, Schema]] = ..., functions: _Optional[_Mapping[str, Function]] = ..., diagnostics: _Optional[_Iterable[_Union[Diagnostic, _Mapping[Any, Any]]]] = ..., provider_meta: _Optional[_Union[Schema, _Mapping[Any, Any]]] = ..., server_capabilities: _Optional[_Union[ServerCapabilities, _Mapping[Any, Any]]] = ...) -> None: ...
    def __init__(self) -> None: ...
...
class GetFunctions(_message.Message):
    ...
    class Response(_message.Message):
        ...
        functions: _containers.MessageMap[str, Function]
        diagnostics: _containers.RepeatedCompositeFieldContainer[Diagnostic]
        def __init__(self, functions: _Optional[_Mapping[str, Function]] = ..., diagnostics: _Optional[_Iterable[_Union[Diagnostic, _Mapping[Any, Any]]]] = ...) -> None: ...
    def __init__(self) -> None: ...
...
class CallFunction(_message.Message):
    ...
    class Request(_message.Message):
        ...
        def __init__(self, name: _Optional[str] = ..., arguments: _Optional[_Iterable[_Union[DynamicValue, _Mapping[Any, Any]]]] = ...) -> None: ...
    class Response(_message.Message):
        __slots__ = ["result", "diagnostics"]
        RESULT_FIELD_NUMBER: _ClassVar[int]
        DIAGNOSTICS_FIELD_NUMBER: _ClassVar[int]
        result: DynamicValue
        diagnostics: _containers.RepeatedCompositeFieldContainer[Diagnostic]
        def __init__(self, result: _Optional[_Union[DynamicValue, _Mapping[Any, Any]]] = ..., diagnostics: _Optional[_Iterable[_Union[Diagnostic, _Mapping[Any, Any]]]] = ...) -> None: ...
    def __init__(self) -> None: ...
