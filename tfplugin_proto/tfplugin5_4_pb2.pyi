...
class GetMetadata(_message.Message):
    ...
    class Request(_message.Message):
        ...
        def __init__(self) -> None: ...
    class Response(_message.Message):
        __slots__ = ["server_capabilities", "diagnostics", "data_sources", "resources"]
...
class GetProviderSchema(_message.Message):
    ...
    class Request(_message.Message):
        ...
        def __init__(self) -> None: ...
    class Response(_message.Message):
        __slots__ = ["provider", "resource_schemas", "data_source_schemas", "diagnostics", "provider_meta", "server_capabilities"]
        ...
        server_capabilities: ServerCapabilities
        def __init__(self, provider: _Optional[_Union[Schema, _Mapping[Any, Any]]] = ..., resource_schemas: _Optional[_Mapping[str, Schema]] = ..., data_source_schemas: _Optional[_Mapping[str, Schema]] = ..., diagnostics: _Optional[_Iterable[_Union[Diagnostic, _Mapping[Any, Any]]]] = ..., provider_meta: _Optional[_Union[Schema, _Mapping[Any, Any]]] = ..., server_capabilities: _Optional[_Union[ServerCapabilities, _Mapping[Any, Any]]] = ...) -> None: ...
    def __init__(self) -> None: ...
